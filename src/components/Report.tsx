      ...
      <div style={{ width: '100%', background: 'var(--surface)', borderBottom: '1px solid var(--border)', padding: '20px 0' }}>
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <button
            ...
            onClick={() => dispatch({ type: 'GO', screen: 'results' })}
          >
            ← 診断結果へ
          </button>
        ...
        <div className="container">
          <div className="fade-in">
            ...
            <p className="small" style={{ color: 'var(--text-3)' }}>
              {basicInfo.grade} ／ {basicInfo.status}
            </p>
          </div>
        </div>
      </div>
              ...
              return (
                <div key={axis} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                  <span style={{
                    width: 88,
                    fontSize: '0.8125rem',
                    fontWeight: isDepth ? 700 : 500,
                    color: isDepth ? 'var(--depth)' : 'var(--text-2)',
                    flexShrink: 0,
                  }}>
                    {isDepth ? '⭐ ' : ''}{meta.label}
                  </span>
                  ...
                  <span style={{ width: 36, textAlign: 'right', fontSize: '0.875rem', fontWeight: 700, color: 'var(--text)' }}>
                    {score}
                  </span>
                </div>
              )
        ...
        <div style={{ width: '100%', padding: '40px 0' }}>
          <div className="container">
            ...
            <div className="card" style={{ borderLeft: '3px solid var(--accent)' }}>
              <p style={{ fontSize: '0.9375rem', lineHeight: 1.85, whiteSpace: 'pre-line' }}>
                {report}
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gap: 20 }}>
            ...
            <div className="card card--sm">
              <h3 style={{ fontSize: '0.875rem', fontWeight: 700, marginBottom: 12, color: 'var(--text-2)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                強み
              </h3>
            ...
            <div className="card card--sm" style={{ background: 'var(--accent-bg)', borderColor: 'rgba(37,99,235,0.15)' }}>
              <h3 style={{ fontSize: '0.875rem', fontWeight: 700, marginBottom: 10, color: 'var(--accent)' }}>
                面接ヒント
              </h3>
            ...
            {/* Next steps */}
            <div>
              <h3 style={{ fontSize: '0.875rem', fontWeight: 700, marginBottom: 14, color: 'var(--text-2)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                次の一歩
              </h3>
